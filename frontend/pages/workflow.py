...
def _v2_run_initial_stream(brief_text: str) -> None:
    ...
    initial_state = AgencyState(
        ...
        creative2_taste=st.session_state.creative2_taste,
        cd_provenance=st.session_state.cd_provenance,
        cd_taste=st.session_state.cd_taste,
        creative1_temperature=st.session_state.creative1_temperature,
        creative2_temperature=st.session_state.creative2_temperature,
        cd_feedback_temperature=st.session_state.cd_feedback_temperature,
        cd_synthesis_temperature=st.session_state.cd_synthesis_temperature,
